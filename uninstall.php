...
delete_option( 'cta_stripe_test_publishable_key' );
delete_option( 'cta_stripe_test_secret_key' );
delete_option( 'cta_stripe_test_webhook_secret' );
delete_option( 'cta_stripe_live_publishable_key' );
delete_option( 'cta_stripe_live_secret_key' );
delete_option( 'cta_stripe_live_webhook_secret' );
delete_option( 'cta_stripe_test_portal_configuration_id' );
