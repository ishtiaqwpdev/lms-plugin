					...
					>
						...
						<div class="form-group">
							...
							<p class="form-hint" id="cta-register-role-hint" style="margin-top:0.35rem;font-size:0.85em;opacity:0.85;">
								<?php echo esc_html__( 'Registered Associates can use CE courses and Exam Preparation right away. Employer/agency details are only required later if you apply for clinical supervision.', 'cta-lms' ); ?>
							</p>
						</div>
