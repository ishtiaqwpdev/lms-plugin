...
class CTA_Activator {
	...
	private static function run_activation() {
		...
		add_option( 'cta_stripe_test_publishable_key', '' );
		add_option( 'cta_stripe_test_secret_key', '' );
		add_option( 'cta_stripe_test_webhook_secret', '' );
		add_option( 'cta_stripe_live_publishable_key', '' );
		add_option( 'cta_stripe_live_secret_key', '' );
