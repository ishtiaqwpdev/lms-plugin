...
return array(
	array(
		'question_text'  => 'A supervisor notices changes in a clinician’s performance but does not yet know whether they reflect ordinary stress, impairment, incompetence, or misconduct. To decide how to proceed, the clinician must apply the correct meaning of professional impairment. Which explanation should guide the next professional step?',
		'option_a'       => 'The presence of any mental-health or medical diagnosis',
		'option_b'       => 'A condition or circumstance that meaningfully interferes with safe, ethical, and effective professional functioning',
		'option_c'       => 'Any stressful event experienced by a clinician',
...
CTA Exam Strategy: Anchor the item to Definition of Professional Impairment. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'The diagnosis automatically establishes professional impairment',
		'option_b'       => 'The therapist must disclose the diagnosis to every client',
		'option_c'       => 'The therapist must permanently stop practicing',
...
CTA Exam Strategy: Keep the tested distinction clear: Diagnosis vs. Impairment. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_a'       => 'A repeated pattern of missed appointments, documentation errors, and declining judgment',
		'option_b'       => 'One difficult session followed by appropriate consultation',
		'option_c'       => 'Participation in continuing education',
...
CTA Exam Strategy: Anchor the item to Pattern and Warning Signs. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'Impairment always excuses misconduct',
		'option_b'       => 'Misconduct can occur only when a clinician intends to harm a client',
		'option_c'       => 'Impairment concerns reduced functioning, while misconduct concerns behavior that violates professional standards',
...
CTA Exam Strategy: Keep the tested distinction clear: Impairment vs. Misconduct. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_a'       => 'Surrender the license immediately',
		'option_b'       => 'Identify the specific functional changes and assess their impact on client safety and professional duties',
		'option_c'       => 'Continue unchanged until a client complains',
...
CTA Exam Strategy: For first-step questions, address immediate client risk and observable functional change before moving to diagnosis, permanent career action, or later administrative consequences.',
	...
	array(
		...
		'option_a'       => 'Any major stressor requires immediate leave',
		'option_b'       => 'Stress and professional impairment are the same concept',
		'option_c'       => 'The therapist is committing misconduct by continuing to work',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'The pattern suggests possible impairment or another competence concern requiring prompt assessment and client-protection planning',
		'option_b'       => 'The clinician is automatically guilty of intentional misconduct',
		'option_c'       => 'No action is appropriate until a client files a complaint',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Prescribed medication automatically establishes impairment',
		'option_b'       => 'The therapist must disclose the prescription to all clients',
		'option_c'       => 'Medication use alone does not establish impairment when professional functioning remains safe and effective',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Wait until the clinician can diagnose the coworker’s condition',
		'option_b'       => 'Protect immediate client safety and follow appropriate supervisory or workplace procedures',
		'option_c'       => 'Discuss the suspected diagnosis with the waiting client',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'The feedback proves a specific diagnosis',
		'option_b'       => 'The therapist must immediately surrender the license',
		'option_c'       => 'External feedback is never relevant to professional functioning',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'They are always identical',
		'option_b'       => 'Incompetence can arise only from inadequate graduate education',
		'option_c'       => 'Impairment may cause or worsen inability to perform safely, but incompetence may also exist without impairment',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_b'       => 'Whether the clinician has ever consumed alcohol',
		'option_c'       => 'Whether coworkers morally disapprove of the clinician’s private conduct',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Assume the pattern is intentional misconduct and begin discipline without further assessment',
		'option_b'       => 'Promptly assess the functional pattern and its effect on client safety, implement proportionate safeguards or coverage as needed, and determine the appropriate next steps',
		'option_c'       => 'Wait until a client complains because fatigue is a private matter',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'A visible disability automatically establishes professional impairment',
		'option_b'       => 'Using an accommodation proves that the clinician cannot practice independently',
		'option_c'       => 'The clinician must disclose private medical details to every client before continuing services',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Publicly announce the concern to warn all clients',
		'option_b'       => 'Ignore the issue because colleague impairment is always private',
		'option_c'       => 'Use appropriate employer, professional, or regulatory channels consistent with the LMFT’s role and the seriousness of the ongoing risk',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Financial pressure is overriding the responsibility to assess and manage impairment affecting client care',
		'option_b'       => 'Any mental-health symptom requires permanent license loss',
		'option_c'       => 'Maintaining income establishes that continuing the caseload is clinically necessary',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Continue because the medical condition is private and the therapist intends to help clients',
		'option_b'       => 'Report the diagnosis to every client and permanently leave the profession',
		'option_c'       => 'Wait for a formal complaint before changing practice',
...
CTA Exam Strategy: For integrated impairment items, sort the facts into SAFETY, FUNCTION, ROLE, RESPONSE, CONTINUITY, and RETURN; choose the option that addresses all six without relying on diagnosis or stigma.',
	...
	array(
		...
		'option_a'       => 'Any use of alcohol, cannabis, or medication by a clinician',
		'option_b'       => 'Substance effects that interfere with the clinician’s ability to provide safe, ethical, and effective professional services',
		'option_c'       => 'A history of treatment for a substance use disorder, regardless of current functioning',
...
CTA Exam Strategy: Anchor the item to Substance Use vs. Impairment. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'Prescription status guarantees that the medication cannot affect professional functioning',
		'option_b'       => 'The therapist must stop the medication immediately if any side effect occurs',
		'option_c'       => 'The therapist must disclose the medication to every client',
...
CTA Exam Strategy: Keep the tested distinction clear: Prescribed Medication. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_b'       => 'Whenever any colleague knows that use occurred',
		'option_c'       => 'Only after the Board files a disciplinary accusation',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'A lawful substance can never be relevant to unprofessional conduct',
		'option_b'       => 'Any alcohol use automatically proves unsafe practice',
		'option_c'       => 'Legal or prescribed status does not eliminate the need to assess whether the clinician can practice safely',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Permanently close the practice',
		'option_b'       => 'Identify the specific functional changes and assess their effect on current duties and client risk',
		'option_c'       => 'Continue unchanged until a client complains',
...
CTA Exam Strategy: For first-step questions, address immediate client risk and observable functional change before moving to diagnosis, permanent career action, or later administrative consequences.',
	...
	array(
		...
		'option_a'       => 'The therapist has committed unprofessional conduct',
		'option_b'       => 'The therapist must disclose the alcohol use to clients',
		'option_c'       => 'The therapist must obtain a substance use diagnosis before working',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_b'       => 'Wait for laboratory confirmation before changing the assignment',
		'option_c'       => 'Allow the session because removing the clinician could be embarrassing',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Continue because a prescription eliminates ethical concern',
		'option_b'       => 'Stop the medication immediately without consulting the prescriber',
		'option_c'       => 'Assess current fitness for crisis work, seek medical guidance, and modify duties or scheduling as needed to protect clients',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Tell clients that the coworker probably has a substance use disorder',
		'option_b'       => 'Focus on the observable performance concerns and client risk, then use appropriate supervisory or workplace channels',
		'option_c'       => 'Ignore the pattern because the cause is uncertain',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Seeking treatment is itself evidence of misconduct',
		'option_b'       => 'Treatment guarantees the clinician is ready for all duties',
		'option_c'       => 'High-risk clients require no additional analysis',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'The colleague must be reported immediately for substance impairment',
		'option_b'       => 'The event proves a substance use disorder',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Off-duty use has become professionally relevant because its effects interfered with an assigned client-safety responsibility',
		'option_b'       => 'The conduct is irrelevant because the alcohol was consumed at home',
		'option_c'       => 'No concern exists unless a client files a complaint',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'The clinician attended a recovery meeting years ago',
		'option_b'       => 'The clinician used alcohol or a drug to an extent or in a manner that was dangerous or injurious, or that impaired the ability to conduct the authorized practice safely',
		'option_c'       => 'A client expressed a moral objection to all alcohol use',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'The supervisor’s license automatically makes the registered AMFT safe to continue',
		'option_b'       => 'Accruing hours is more important than disclosing a temporary limitation',
		'option_c'       => 'The registered AMFT should continue until a client is actually harmed',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'It requires every clinician who drinks alcohol to enter Board probation',
		'option_b'       => 'It is a general self-care checklist that replaces profession-specific ethical standards',
		'option_c'       => 'It incorporates substance-abuse uniform standards and disciplinary guidelines for the Board’s decision-making in disciplinary cases; it does not automatically govern every possible concern before discipline',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Use a staged return based on demonstrated functioning, relevant treatment or fitness recommendations, and appropriate monitoring rather than treating abstinence alone as proof of readiness',
		'option_b'       => 'Restore the full crisis caseload because any period of abstinence conclusively establishes safe functioning',
		'option_c'       => 'Permanently exclude the therapist from practice because prior substance-related impairment is irreversible',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Continue unchanged because legal use and treatment eliminate professional concern',
		'option_b'       => 'Ask clients to sign waivers accepting the therapist’s reduced alertness',
		'option_c'       => 'Conceal the concern unless the Board opens an investigation',
...
CTA Exam Strategy: Anchor the item to Condition vs. Impairment. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'The therapist must disclose the diagnosis to every client',
		'option_b'       => 'The therapist is automatically impaired because anxiety is present',
		'option_c'       => 'The therapist must permanently stop practicing',
...
CTA Exam Strategy: Anchor the item to Burnout Definition. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'It is identical to every form of occupational stress',
		'option_b'       => 'It is a formal diagnosis that automatically requires leave',
...
CTA Exam Strategy: Keep the tested distinction clear: Compassion Fatigue and Secondary Traumatic Stress. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_a'       => 'Permanently stop practicing before gathering more information',
		'option_b'       => 'Identify the specific functional changes and assess their pattern, severity, and effect on client safety',
		'option_c'       => 'Ignore the signs until a client complains',
...
CTA Exam Strategy: For first-step questions, address immediate client risk and observable functional change before moving to diagnosis, permanent career action, or later administrative consequences.',
	...
	array(
		...
		'option_a'       => 'Grief automatically constitutes professional impairment',
		'option_b'       => 'The clinician must disclose the loss to all clients',
		'option_c'       => 'The clinician is engaging in misconduct by continuing to work',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Evaluate the functional decline and use proportionate workload, support, treatment, or supervision changes before the pattern worsens',
		'option_b'       => 'Continue unchanged because burnout is common in helping professions',
		'option_c'       => 'Permanently leave the profession because burnout is irreversible',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Entering personal therapy is evidence of professional misconduct',
		'option_b'       => 'Treatment guarantees readiness for all professional duties',
		'option_c'       => 'Crisis clients do not require special analysis',
		'option_d'       => 'The clinician has not adequately addressed the immediate effect of impaired functioning on current client care',
		'correct_option' => 'd',
		'explanation'    => 'A. Incorrect. Seeking treatment is responsible and should not be treated as misconduct.
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'One nonspecific event does not establish professional impairment; monitor functioning and respond if a pattern or client impact emerges',
		'option_b'       => 'The therapist must be reported immediately as impaired',
		'option_c'       => 'The event proves a mental health disorder',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Tell clients that the colleague probably has a mental illness',
		'option_b'       => 'Ignore the pattern because the observer cannot diagnose the cause',
		'option_c'       => 'Focus on observable performance and client risk, then use appropriate supervisory or workplace channels',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Any mental health diagnosis automatically requires license revocation',
		'option_b'       => 'An employer may independently order the BBS medical examination described by the statute',
		'option_c'       => 'Burnout is legally defined as a mental illness that always prevents practice',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Identify the overlapping burnout and trauma-exposure reactions, assess current client risk, and use a proportionate plan addressing both work conditions and professional functioning',
		'option_b'       => 'Choose one perfect label before taking any protective action',
		'option_c'       => 'Continue unchanged because overlapping symptoms cannot be evaluated',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Accept the registered AMFT’s reassurance because supervisees control how much functional information they disclose',
		'option_b'       => 'Wait for actual client harm before changing assignments',
		'option_c'       => 'Conduct a focused assessment of current functioning and risk, require accurate information, modify assignments or arrange coverage as needed, and document and monitor the response',
...
CTA Exam Strategy: Anchor the item to Condition vs. Professional Impairment. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'The disability automatically establishes incompetence',
		'option_b'       => 'The clinician must disclose the medical diagnosis to every client',
		'option_c'       => 'Adaptive equipment lowers the professional standard of care',
...
CTA Exam Strategy: Keep the tested distinction clear: Disability and Competence. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_a'       => 'Slower reaction time, reduced attention, limited short-term memory, and impaired judgment',
		'option_b'       => 'More reliable concentration and faster decision-making',
		'option_c'       => 'Improved recall and reduced error risk',
...
CTA Exam Strategy: Anchor the item to Effects of Fatigue. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'To excuse the clinician from all essential professional responsibilities',
		'option_b'       => 'To establish that the clinician is impaired',
		'option_c'       => 'To enable the clinician to perform essential duties safely and effectively when a workable adjustment is available',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Assume experience will compensate for the problem',
		'option_b'       => 'End the career permanently before gathering more information',
		'option_c'       => 'Wait until a client complains',
...
CTA Exam Strategy: For first-step questions, address immediate client risk and observable functional change before moving to diagnosis, permanent career action, or later administrative consequences.',
	...
	array(
		...
		'option_a'       => 'Assess current fitness, modify affected duties as needed, and coordinate medically rather than assuming prescription status makes the effects irrelevant',
		'option_b'       => 'Continue unchanged because prescribed medication cannot affect competence',
		'option_c'       => 'Stop the medication immediately without consulting the prescriber',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Treat any chronic pain as permanent incompetence',
		'option_b'       => 'Continue the same schedule because no client has complained',
		'option_c'       => 'Evaluate whether schedule changes, breaks, reduced consecutive sessions, or other accommodations preserve reliable functioning',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Whether the clinician has ever requested accommodation',
		...
		'option_c'       => 'Whether coworkers know the medical diagnosis',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Proceed because dedication compensates for sleep loss',
		'option_b'       => 'Ask the client whether the fatigue is acceptable',
		'option_c'       => 'Drink caffeine and treat the concern as resolved',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_b'       => 'Continue all sessions because the condition is temporary',
		'option_c'       => 'Abruptly disappear without communicating any service plan',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Any hearing limitation automatically prevents psychotherapy',
		'option_b'       => 'The clinician may continue when the accommodation reliably preserves the essential professional functions involved',
		'option_c'       => 'The technology proves the clinician is incompetent',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Drive slowly and rely on experience',
		'option_b'       => 'Ask the client to accept the transportation risk',
		'option_c'       => 'Continue because the clinician is on call',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Any visible disability justifies automatic removal from clinical work',
		'option_b'       => 'The employer should use an individualized, good-faith accommodation process and assess whether the therapist can perform essential duties safely with reasonable support',
		'option_c'       => 'The therapist must prove that no limitation exists',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Continue crisis work because accommodations were attempted',
		'option_b'       => 'Let clients decide whether the episodes are acceptable',
		'option_c'       => 'Remove or reassign the unsafe high-risk duties, arrange continuity, pursue appropriate medical and workplace processes, and reevaluate before resuming them',
...
CTA Exam Strategy: For integrated impairment items, sort the facts into SAFETY, FUNCTION, ROLE, RESPONSE, CONTINUITY, and RETURN; choose the option that addresses all six without relying on diagnosis or stigma.',
	...
	array(
		...
		'option_a'       => 'Preserve the therapist’s full income before considering practice changes',
		'option_b'       => 'Take timely action that protects clients and addresses the impaired professional functioning',
		'option_c'       => 'Wait until a client files a complaint so the concern is confirmed',
...
CTA Exam Strategy: Anchor the item to Primary Ethical Responsibility. Eliminate options based only on diagnosis, stigma, confidence, income, or an unnecessarily permanent response when the facts call for functional assessment and proportionate protection.',
	...
	array(
		...
		'option_a'       => 'Treatment proves the clinician can immediately resume every professional duty',
		'option_b'       => 'Treatment transfers responsibility for client safety to the treatment provider',
		'option_c'       => 'Treatment is relevant only after a licensing complaint is filed',
...
CTA Exam Strategy: Keep the tested distinction clear: Treatment vs. Current Practice Safety. Separate a condition, stressor, treatment status, or accommodation from its demonstrated effect on safe and effective professional functioning.',
	...
	array(
		...
		'option_a'       => 'Selecting the least disruptive action that still adequately protects clients',
		'option_b'       => 'Choosing permanent career termination whenever any warning sign appears',
		'option_c'       => 'Continuing all duties unless actual client harm has already occurred',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'Ask clients to decide whether the clinician is fit to continue',
		'option_b'       => 'Delay all action until the clinician’s private treatment is completed',
		'option_c'       => 'Arrange appropriate coverage, referral, transfer, or other continuity protections',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_b'       => 'Continue unchanged because no client has complained',
		'option_c'       => 'Permanently close the practice before assessing whether support is effective',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Complete the assessment quickly before the symptoms worsen',
		'option_b'       => 'Begin the session and ask the client to report any clinician errors',
		'option_c'       => 'Prevent the unsafe duty and arrange qualified immediate coverage or another protective alternative',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'The registered AMFT must disclose every detail of personal treatment to the supervisor',
		'option_b'       => 'The incomplete disclosure prevents the supervisor from adequately evaluating client risk and safe assignments',
		'option_c'       => 'Weekly supervision automatically makes the assigned work safe',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Notify all of the colleague’s clients before speaking with anyone else',
		'option_b'       => 'Ignore the concern because colleague functioning is always private',
		'option_c'       => 'Diagnose the colleague and place the diagnosis in a shared record',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_b'       => 'Document only that “the clinician is impaired” without facts or a plan',
		'option_c'       => 'Include every private health detail so the record appears comprehensive',
...
CTA Exam Strategy: Apply the functional standard to the facts: identify what has changed, how client care is affected, and which proportionate safeguard or professional response follows.',
	...
	array(
		...
		'option_a'       => 'The therapist’s prior reputation for excellent work',
		'option_b'       => 'Whether clients have threatened to complain',
		'option_c'       => 'Current professional functioning and the need to protect clients, even if duties or income must change',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Seeking treatment demonstrates professional misconduct',
		'option_b'       => 'The clinician has not adequately addressed the current effect on client care and professional duties',
		'option_c'       => 'High-risk clients should never be treated by a clinician receiving personal care',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Schedule a private conversation for the next day and allow the session to proceed',
		'option_b'       => 'Send an anonymous message to the entire staff about suspected substance use',
		'option_c'       => 'Wait for objective proof of a specific diagnosis before intervening',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Continue a staged or restricted return and base fuller duties on demonstrated functioning',
		'option_b'       => 'Resume the full caseload because subjective improvement is sufficient',
		'option_c'       => 'Permanently end the therapist’s career because recovery is incomplete',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'Keep all assignments unchanged because willingness to seek treatment resolves the concern',
		'option_b'       => 'Protect clients by modifying or stopping affected assignments, increasing oversight, setting measurable remediation, arranging continuity, and monitoring recovery',
		'option_c'       => 'Provide the registered AMFT’s personal treatment within supervision to maintain control',
...
CTA Exam Strategy: In impairment scenarios, prioritize observable functioning and client risk, then select the least extreme response that still provides adequate protection, supervision, continuity, and reassessment.',
	...
	array(
		...
		'option_a'       => 'The diagnosis must be reported immediately to the BBS',
		'option_b'       => 'Every clinician in treatment must suspend practice until the Board approves return',
		'option_c'       => 'Treatment or diagnosis alone does not create an automatic BBS report; evaluate observable functioning and any specific legal or professional duty',
...
CTA Exam Strategy: Match the facts to the exact legal standard—current ability to practice safely, observable impairment, and the authorized Board process—rather than moral judgment, diagnosis alone, or an invented reporting duty.',
	...
	array(
		...
		'option_a'       => 'Continue because treatment has begun and no complaint has been filed',
		'option_b'       => 'Disclose the diagnosis to every client and permanently surrender the license',
		'option_c'       => 'Wait for the supervisor to independently discover whether the therapist is impaired',
