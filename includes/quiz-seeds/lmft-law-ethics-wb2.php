...
return array(
	array(
		'question_text'  => 'A therapist is preparing to offer remote psychotherapy for the first time and must determine whether the proposed service qualifies as telehealth under California law. Which statement most accurately describes telehealth under California law?',
		'option_a'       => 'Any electronic communication between a therapist and client, including an appointment reminder.',
		'option_b'       => 'A mode of delivering health care through information and communication technologies that may include real-time interactions and asynchronous store-and-forward transfers.',
		'option_c'       => 'Psychotherapy delivered only through live video when the therapist and client are in different counties.',
...
CTA Exam Strategy: Separate the delivery method from the underlying service. Telehealth cannot make an unauthorized service lawful.',
	...
	array(
		...
		'option_a'       => 'Continue by telephone automatically because any electronic method is equivalent.',
		'option_b'       => 'End treatment permanently because the video platform failed once.',
		'option_c'       => 'Assess whether the alternate method can support a clinically appropriate, confidential, and safe session, and follow the established backup plan.',
...
CTA Exam Strategy: For associates, analyze both jurisdictions and preserve all supervision requirements.',
	...
	array(
		...
		'option_a'       => 'The therapist may automatically continue telehealth because the visit is shorter than 30 days.',
		'option_b'       => 'The therapist may not provide any service under any circumstances because California has no temporary allowance.',
		'option_c'       => 'The therapist may proceed after obtaining telehealth informed consent; no Board contact is required.',
...
CTA Exam Strategy: Licensure and experience are not substitutes for specific competence.',
	...
	array(
		...
		'option_a'       => 'Do not assume that continuity or clinical need creates authority; verify whether a lawful Arizona pathway exists and, if not, develop an appropriate transition and continuity plan.',
		'option_b'       => 'Continue for 90 days because access barriers create an automatic grace period.',
...
CTA Exam Strategy: For an integrated question, choose the answer that addresses every material problem without relying on a single form, platform, or extreme action.',
	...
	array(
		...
		'option_a'       => 'Only through a signed telehealth form.',
		'option_b'       => 'Verbally or in writing, provided the consent is documented.',
		'option_c'       => 'Only through a recorded verbal statement.',
...
CTA Exam Strategy: Eliminate answers that impose a written-form requirement not found in the statute.',
	...
	array(
		...
		'option_a'       => 'After the third telehealth session.',
		'option_b'       => 'Only if the client asks about technology risks.',
		'option_c'       => 'At treatment termination.',
...
CTA Exam Strategy: When the question asks what must be provided, look for the exact BBS credential information.',
	...
	array(
		...
		'option_a'       => 'The consent is invalid because verbal consent is never allowed.',
		'option_b'       => 'No problem exists because the client verbally agreed.',
		'option_c'       => 'The therapist must record the entire conversation to prove consent.',
...
CTA Exam Strategy: Do not confuse a required process with a required document format.',
	...
	array(
		...
		'option_a'       => 'The therapist should have obtained a notarized signature.',
		'option_b'       => 'The therapist needed the client to sign at every video session.',
...
CTA Exam Strategy: A signature is evidence only of what the document and surrounding process actually covered.',
	...
	array(
		...
		'option_a'       => 'The prior telehealth consent permanently waives in-person care.',
		'option_b'       => 'The therapist must personally provide an in-person appointment within 24 hours.',
		'option_c'       => 'The client must revoke telehealth consent in writing before discussing any other format.',
...
CTA Exam Strategy: Choose the precise local-resource requirement rather than a broader crisis-practice recommendation.',
	...
	array(
		...
		'option_a'       => 'No discussion is needed because the client once consented to telehealth generally.',
		'option_b'       => 'Obtain a new signed form at every session after the platform change.',
...
CTA Exam Strategy: The trigger is material change, not merely the passage of time.',
	...
	array(
		...
		'option_a'       => 'Clarify the privacy limitation, explore the concern and available options, reassess continued telehealth participation, and document the discussion.',
		'option_b'       => 'Rely on the original signature and tell the client the issue is closed.',
...
CTA Exam Strategy: Integrated questions require a response that fixes every material defect without relying on a signature or an extreme action.',
	...
	array(
		...
		'option_a'       => 'Privacy and confidentiality refer only to technology, while security refers only to the physical room.',
		'option_b'       => 'Privacy concerns who can observe or access the session, confidentiality is the therapist’s duty regarding use and disclosure, and security involves safeguards protecting information and systems.',
		'option_c'       => 'Privacy is a client preference, but confidentiality and security are optional when telehealth consent is signed.',
...
CTA Exam Strategy: Define the problem before solving it. The exam may use one word while the facts involve all three.',
	...
	array(
		...
		'option_a'       => 'Use only a platform named on an official BBS approved-product list.',
		'option_b'       => 'Guarantee that no unauthorized person can ever access the client’s information.',
		'option_c'       => 'Obtain a new written HIPAA authorization before every session.',
...
CTA Exam Strategy: Look for the regulation’s actual duty, not an invented product list, guarantee, or repeated authorization.',
	...
	array(
		...
		'option_a'       => 'The therapist still has a confidentiality problem because platform security does not correct environmental exposure.',
		'option_b'       => 'Encryption makes the session confidential regardless of who can hear it.',
		'option_c'       => 'The therapist’s environment is irrelevant if the client agreed to telehealth.',
...
CTA Exam Strategy: When the facts involve an open room or visible screen, do not let the word “encrypted” distract you.',
	...
	array(
		...
		'option_a'       => 'They are the same law and apply to exactly the same persons in every situation.',
		'option_b'       => 'A therapist who is not a federal HIPAA covered entity has no California confidentiality duties.',
		'option_c'       => 'The CMIA is California law, while federal HIPAA directly applies to covered entities and business associates; California BBS telehealth rules also expressly reference both frameworks.',
...
CTA Exam Strategy: Avoid the common distractor that treats HIPAA as the only source of confidentiality law.',
	...
	array(
		...
		'option_a'       => 'Continue because the client voluntarily chose the location.',
		'option_b'       => 'Immediately terminate the therapeutic relationship.',
		'option_c'       => 'Pause sensitive discussion, assess who may hear or see the session, discuss realistic privacy options, and determine whether the session can proceed appropriately.',
...
CTA Exam Strategy: The best first response to environmental exposure is usually pause, assess, and restore privacy.',
	...
	array(
		...
		'option_a'       => 'No action is needed because the devices are not human listeners.',
		'option_b'       => 'Disable or remove unnecessary listening or recording devices and reassess the privacy of the therapist’s environment.',
		'option_c'       => 'Ask every client to accept responsibility for any recording by the devices.',
...
CTA Exam Strategy: Environmental risk includes devices that listen, not only people who are physically present.',
	...
	array(
		...
		'option_a'       => 'Pause sensitive discussion, identify who is present, clarify the client’s wishes, and assess privacy, coercion, and treatment impact.',
		'option_b'       => 'Assume the person has permission because the client did not object.',
		'option_c'       => 'Continue but avoid documenting the interruption.',
...
CTA Exam Strategy: Unexpected presence calls for clarification before either continuing or taking an extreme action.',
	...
	array(
		...
		'option_a'       => 'Rely on the certification because HHS approves compliant telehealth products.',
		'option_b'       => 'Assume the platform is safe for every workflow and client population.',
		'option_c'       => 'Recognize that HHS does not certify products, independently evaluate the service and safeguards, and obtain a BAA when legally required.',
...
CTA Exam Strategy: “Certified” and “compliant” are marketing clues. Look for independent assessment rather than blind reliance.',
	...
	array(
		...
		'option_a'       => 'Guarantee privacy because the office door is closed.',
		'option_b'       => 'Continue without discussion because monitoring would be the employer’s responsibility.',
		'option_c'       => 'Terminate telehealth because workplace devices are always unlawful.',
...
CTA Exam Strategy: A private room can still contain an insecure or monitored device. Evaluate both layers.',
	...
	array(
		...
		'option_a'       => 'Every therapist must obtain a BAA from every telephone or internet provider in every circumstance.',
		...
		'option_c'       => 'A signed BAA automatically makes every platform feature and therapist practice compliant.',
...
CTA Exam Strategy: Do not choose an absolute. Analyze covered-entity status, vendor function, contract, and safeguards.',
	...
	array(
		...
		'option_a'       => 'Continue because telehealth consent includes consent to all platform features.',
		'option_b'       => 'Record only the therapist’s side of the session without telling the client.',
		'option_c'       => 'Disable the feature unless and until the therapist establishes a lawful clinical purpose, obtains required consent, and addresses storage, access, retention, and vendor use.',
...
CTA Exam Strategy: Treat recording and transcription as separate data-creation events, not ordinary telehealth features.',
	...
	array(
		...
		'option_a'       => 'Secure or disable access when possible, determine what information was on the device and how it was protected, and begin the applicable incident-response process.',
		'option_b'       => 'Wait to see whether a client complains before taking action.',
		'option_c'       => 'Delete the clients’ records from the practice system to reduce exposure.',
...
CTA Exam Strategy: Incident first steps are containment and assessment, not waiting, deleting, or making unsupported conclusions.',
	...
	array(
		...
		'option_a'       => 'Take no further action because removal ended the incident.',
		'option_b'       => 'Delete the session documentation so the information cannot be discovered.',
		'option_c'       => 'Immediately report a confirmed breach to every client in the practice.',
...
CTA Exam Strategy: For sophisticated incident questions, choose the complete response that separates containment from legal breach determination.',
	...
	array(
		...
		'option_a'       => 'The therapist is correct because federal covered-entity status is the only source of telehealth security duties.',
		'option_b'       => 'The therapist is automatically a federal HIPAA covered entity solely because the therapist holds a BBS license.',
		'option_c'       => 'Federal HIPAA covered-entity status may require a separate analysis, but California law, the CMIA, professional confidentiality duties, and 16 CCR section 1815.5’s reference to HIPAA security standards still must be considered.',
...
CTA Exam Strategy: This is a dual-framework question. Do not collapse federal HIPAA status and California BBS duties into one issue.',
	...
	array(
		...
		'option_a'       => 'Confront the suspected person loudly and demand that the person leave.',
		'option_b'       => 'Use a neutral, safety-conscious approach to determine whether the client can speak freely, implement an agreed privacy or safety method, and modify the session based on risk.',
		'option_c'       => 'Assume the client consented to the other person’s presence because the client said privacy was fine.',
...
CTA Exam Strategy: When coercion may be present, privacy assessment is also a safety assessment. Avoid actions that could escalate danger.',
	...
	array(
		...
		'option_a'       => 'The vendor may still be a business associate because it maintains ePHI on the practice’s behalf, and encryption without the key does not eliminate the BAA requirement.',
		'option_b'       => 'No BAA can ever be required when the vendor cannot view the recordings.',
		'option_c'       => 'Encryption makes risk analysis and access-control planning unnecessary.',
...
CTA Exam Strategy: The key verb is “maintains.” A no-view cloud vendor can still be a business associate.',
	...
	array(
		...
		'option_a'       => 'Obtain a new telehealth consent signature; the signature resolves the vendor, environment, transcription, and login issues.',
		'option_b'       => 'Continue because no confirmed harm or client complaint has occurred.',
		'option_c'       => 'Delete all electronic records and stop telehealth immediately.',
...
CTA Exam Strategy: Integrated questions reward the answer that addresses every material problem in a lawful sequence without relying on one document or an extreme reaction.',
	...
	array(
		...
		'option_a'       => 'An automated appointment reminder that contains no clinical information.',
		'option_b'       => 'A secure asynchronous message in which the therapist assesses symptoms and provides treatment guidance.',
		'option_c'       => 'A receipt confirming that a copayment was processed.',
...
CTA Exam Strategy: Look at the purpose and content, not merely the fact that technology was used.',
	...
	array(
		...
		'option_a'       => 'Email is prohibited whenever the message relates to treatment.',
		'option_b'       => 'Only patient portals may be used for any health-related communication.',
		'option_c'       => 'Unencrypted email is automatically a HIPAA violation in every circumstance.',
...
CTA Exam Strategy: Avoid absolute words such as “never,” “only,” and “automatic” when official guidance uses a reasonable-safeguards standard.',
	...
	array(
		...
		'option_a'       => 'To prevent the client from assuming that messages are continuously monitored or appropriate for emergencies.',
		'option_b'       => 'To eliminate the therapist’s duty to respond to any message that is actually received.',
		'option_c'       => 'To make every future electronic exchange confidential regardless of the method used.',
...
CTA Exam Strategy: Communication policies clarify expectations; they do not erase professional duties.',
	...
	array(
		...
		'option_a'       => 'They must be kept only on paper.',
		'option_b'       => 'Electronic communications can never become part of the health-service record.',
		'option_c'       => 'Health-service records may be retained in written or electronic form, and clinically significant electronic communications may need to be incorporated into the record.',
...
CTA Exam Strategy: Technology changes the form of the record, not the importance of clinically significant information.',
	...
	array(
		...
		'option_a'       => 'The client has waived confidentiality for all future email communication.',
		'option_b'       => 'The therapist may send unlimited clinical detail because the client emailed first.',
		'option_c'       => 'The therapist must refuse to use email under all circumstances.',
...
CTA Exam Strategy: Client choice informs the analysis but does not transfer professional responsibility.',
	...
	array(
		...
		'option_a'       => 'The reminder automatically becomes psychotherapy.',
		'option_b'       => 'The message may disclose contact information and suggest that each recipient has a relationship with the therapist or practice.',
		'option_c'       => 'Appointment reminders are prohibited by HIPAA.',
...
CTA Exam Strategy: “No diagnosis was included” does not eliminate the risk of revealing who receives services.',
	...
	array(
		...
		'option_a'       => 'Promptly assess the current risk and respond according to the facts, document the message and actions, and review communication expectations as appropriate.',
		'option_b'       => 'Ignore the message because the policy completely eliminates responsibility for messages sent after hours.',
		'option_c'       => 'Assume the risk has passed because several hours have elapsed.',
...
CTA Exam Strategy: Distinguish not seeing a message from seeing it and choosing not to act.',
	...
	array(
		...
		'option_a'       => 'Delete the message because portal communications are outside the clinical record.',
		'option_b'       => 'Document only that a message was received, without its clinical effect.',
...
CTA Exam Strategy: Ask whether the message changed assessment, treatment, risk, or follow-up.',
	...
	array(
		...
		'option_a'       => 'Refuse automatically because unencrypted email is always illegal.',
		'option_b'       => 'Agree without discussing risk because the client requested the method.',
		'option_c'       => 'Use email for any content once the client signs a blanket waiver.',
...
CTA Exam Strategy: The strongest answer balances access, client preference, risk, and safeguards rather than choosing an absolute.',
	...
	array(
		...
		'option_a'       => 'Begin responding immediately every evening to preserve rapport.',
		'option_b'       => 'Address the pattern clinically and clarify the approved purpose, response time, and boundaries for texting.',
		'option_c'       => 'Block the client without discussion.',
...
CTA Exam Strategy: For nonemergency boundary concerns, the exam usually favors clarification and clinical discussion before an extreme action.',
	...
	array(
		...
		'option_a'       => 'Rely on the first address suggested by auto-complete.',
		'option_b'       => 'Send the message to the client and ask the client to forward it.',
		'option_c'       => 'Verify the authorization, recipient address, intended attachment, and appropriateness of the transmission method before sending.',
...
CTA Exam Strategy: The exam favors verification before transmission rather than repair after a preventable error.',
	...
	array(
		...
		'option_b'       => 'It cannot be telehealth because no video was used.',
		'option_c'       => 'It is merely administrative because it occurred between scheduled sessions.',
...
CTA Exam Strategy: When the therapist assesses or treats through technology, think beyond video and consider asynchronous telehealth.',
	...
	array(
		...
		'option_a'       => 'Delete the message immediately because the client owns all treatment information.',
		'option_b'       => 'Honor the request because texting is outside the clinical record.',
		'option_c'       => 'Save the screenshot but take no clinical action until the next appointment.',
...
CTA Exam Strategy: A request for secrecy does not remove risk-management and documentation responsibilities.',
	...
	array(
		...
		'option_a'       => 'Use of a personal device is always prohibited, so no further analysis is needed.',
		'option_b'       => 'Password protection makes every use of the device appropriate.',
		'option_c'       => 'The therapist should assess and correct the foreseeable privacy, access, boundary, and record-control risks rather than treating the device as automatically permitted or prohibited.',
...
CTA Exam Strategy: When the facts show manageable risks, choose assessment and correction rather than an unsupported automatic conclusion.',
	...
	array(
		...
		'option_a'       => 'Immediately forward the text to the other partner because couples have no individual confidentiality interests.',
		'option_b'       => 'Assess the clinical, confidentiality, informed-consent, safety, and treatment-agreement issues; clarify how individual communications will be handled; document the significant interaction; and consult if needed.',
		'option_c'       => 'Delete the text and pretend it was never received.',
...
CTA Exam Strategy: Complex electronic communication does not replace the underlying informed-consent and confidentiality analysis.',
	...
	array(
		...
		'option_a'       => 'Treat the message as an urgent medical and safety concern, attempt immediate contact and appropriate emergency response using available information, and document the message and actions.',
		'option_b'       => 'Wait until the routine portal response deadline because the automated notice controls.',
		'option_c'       => 'Reply only with a copy of the communication policy.',
...
CTA Exam Strategy: A disclaimer is preventive guidance, not a substitute for action after actual notice of danger.',
	...
	array(
		...
		'option_a'       => 'Continue because clients prefer having many communication options.',
		'option_b'       => 'Eliminate every form of electronic communication immediately, regardless of client access needs.',
		'option_c'       => 'Add a disclaimer stating that the therapist is not responsible for any electronic message.',
...
CTA Exam Strategy: In an integrated question, select the answer that repairs the entire system rather than relying on preference, prohibition, or a disclaimer.',
	...
	array(
		...
		'option_a'       => 'Professional boundaries apply only during scheduled therapy sessions.',
		'option_b'       => 'The therapist should apply confidentiality, boundary, advertising, and client-welfare principles to online conduct just as the therapist would in other professional settings.',
		'option_c'       => 'A personal account is exempt from professional analysis whenever the therapist uses a privacy setting.',
...
CTA Exam Strategy: Choose the answer that applies existing professional principles rather than treating social media as a separate legal universe.',
	...
	array(
		...
		'option_a'       => 'The therapist’s first and last name as filed with the Board, license number, and complete license title or approved abbreviation.',
		'option_b'       => 'The therapist’s graduate degree and malpractice carrier.',
		'option_c'       => 'The therapist’s specialties and years of experience.',
...
CTA Exam Strategy: Social media is advertising. Look for name, license type, and license number.',
	...
	array(
		...
		'option_a'       => 'The client may disclose the client’s own experience, but the post does not authorize the therapist to confirm the relationship or reveal treatment information.',
		'option_b'       => 'The client has waived all confidentiality because the post is public.',
		'option_c'       => 'The therapist may repost the review with details from the record.',
...
CTA Exam Strategy: The client controls the client’s own speech; the therapist remains bound by confidentiality.',
	...
	array(
		...
		'option_a'       => 'Public information is automatically reliable clinical evidence.',
		'option_b'       => 'The therapist may search and use it for any reason because no password was required.',
		'option_c'       => 'Public availability does not establish clinical necessity, accuracy, or appropriateness; the therapist should evaluate purpose, reliability, impact, and documentation.',
...
CTA Exam Strategy: Avoid both extremes: “public means free to use” and “public information can never matter.”',
	...
	array(
		...
		'option_a'       => 'They make client friend requests ethically harmless.',
		'option_b'       => 'They guarantee that clients cannot locate personal information.',
		'option_c'       => 'They remove all advertising requirements from the professional account.',
...
CTA Exam Strategy: When an option promises that a technology choice “guarantees” privacy or removes duties, eliminate it.',
	...
	array(
		...
		'option_a'       => 'Accept immediately to avoid making the client feel rejected.',
		'option_b'       => 'Pause, review the social-media policy and the specific boundary, confidentiality, and treatment implications, and address the request consistently and clinically.',
		'option_c'       => 'Block the client immediately and refuse to discuss the request.',
...
CTA Exam Strategy: California-style questions usually favor thoughtful boundary assessment over an automatic click, block, or termination.',
	...
	array(
		...
		'option_a'       => 'The profile may imply licensed independent practice and omits the complete associate title, employer or volunteer entity, and statement of supervision by a licensed person.',
		'option_b'       => 'Associates are prohibited from using any social-media advertising.',
		'option_c'       => 'The only missing item is the supervisor’s home address.',
...
CTA Exam Strategy: For associate ads, look for status, number, employer/entity, and supervision - not merely a credential number.',
	...
	array(
		...
		'option_a'       => 'The therapist failed to use the client’s full legal name in the response.',
		'option_b'       => 'The response is permissible because the client criticized the therapist first.',
		'option_c'       => 'The therapist publicly confirmed the treatment relationship and disclosed treatment, attendance, safety, and billing information.',
...
CTA Exam Strategy: A defensive response is not an exception to confidentiality.',
	...
	array(
		...
		'option_a'       => 'The post is confidential because the group is limited to professionals.',
		'option_b'       => 'The post is permitted because the therapist did not use the client’s name.',
		'option_c'       => 'The post is acceptable if the therapist deletes it after receiving advice.',
...
CTA Exam Strategy: No name is not enough. Ask whether the audience and combined details create identification risk.',
	...
	array(
		...
		'option_a'       => 'The practice is required because clients may omit information during intake.',
		'option_b'       => 'The therapist lacks a clear clinical purpose and should evaluate necessity, proportionality, transparency, reliability, and treatment impact before searching.',
		'option_c'       => 'The practice is harmless because the information is public.',
...
CTA Exam Strategy: Purpose before curiosity is the key clue.',
	...
	array(
		...
		'option_a'       => 'Assess credibility and immediacy, attempt appropriate contact, use available safety and location information, take proportionate protective action under applicable law, and document the response.',
		'option_b'       => 'Ignore the post because the therapist did not receive it directly from the client.',
		'option_c'       => 'Assume the post proves a specific crime and notify the client’s employer publicly.',
...
CTA Exam Strategy: In a safety question, verify and assess promptly; do not ignore or overreact publicly.',
	...
	array(
		...
		'option_a'       => 'Ignore the message because the client used a prohibited channel.',
		'option_b'       => 'Block the client immediately so no additional messages arrive.',
		'option_c'       => 'Respond according to the urgency and safety needs, preserve or document clinically significant information, and later redirect future communication to the approved channel.',
...
CTA Exam Strategy: Policies prevent confusion; actual knowledge of risk still requires clinical action.',
	...
	array(
		...
		'option_a'       => 'The like is always required to support the client’s recovery.',
		'option_b'       => 'A like can never create a confidentiality issue because it contains no words.',
		'option_c'       => 'The therapist must immediately terminate treatment because any online interaction is prohibited.',
...
CTA Exam Strategy: Online signals such as likes, follows, and tags can disclose by association.',
	...
	array(
		...
		'option_a'       => 'Termination automatically converts the relationship into an ordinary friendship.',
		'option_b'       => 'Confidentiality continues after treatment, and boundary and multiple-relationship concerns may remain; the therapist should assess the request rather than assume acceptance is harmless.',
		'option_c'       => 'The therapist is legally required to accept because the person is no longer a client.',
...
CTA Exam Strategy: Former does not mean ordinary. Confidentiality survives termination.',
	...
	array(
		...
		'option_a'       => 'The arrangement raises serious concerns about undue influence, exploitation of the treatment relationship, public identification, confidentiality, and misleading advertising; the therapist should not treat client consent or compensation as automatically curing those concerns.',
		'option_b'       => 'The arrangement is automatically ethical because each client can decline.',
		'option_c'       => 'The arrangement is required if the therapist wants to use client reviews.',
...
CTA Exam Strategy: In advertising questions, evaluate every representation from the consumer’s perspective.',
	...
	array(
		...
		'option_a'       => 'Keep the account because each activity occurred on a public platform.',
		'option_b'       => 'Delete only the negative-review response; the remaining practices are personal preferences.',
		'option_c'       => 'Ask every client to sign a broad social-media waiver and continue the same practices.',
...
CTA Exam Strategy: For an integrated challenge, choose the answer that corrects every material problem rather than relying on publicity, deletion of one post, or a blanket waiver.',
	...
	array(
		...
		'option_a'       => 'Risk analysis trains staff, while risk management reports every incident to regulators.',
		'option_b'       => 'Risk analysis identifies and evaluates threats and vulnerabilities; risk management selects, implements, and monitors safeguards.',
		'option_c'       => 'Risk analysis occurs only after a breach, while risk management occurs only before technology is purchased.',
...
CTA Exam Strategy: Security is not only secrecy. Lost or inaccessible records point to availability.',
	...
	array(
		...
		'option_a'       => 'It should be contained and assessed promptly, but it is not automatically a legally reportable breach.',
		'option_b'       => 'It should be reported to the BBS before the therapist gathers any facts.',
		'option_c'       => 'It may be ignored until a client proves actual financial harm.',
...
CTA Exam Strategy: Do not confuse “respond immediately” with “automatically report to every authority.”',
	...
	array(
		...
		'option_a'       => 'Installing a privacy screen on a laptop.',
		'option_b'       => 'Encrypting a portable drive.',
		'option_c'       => 'Conducting a documented risk analysis and training workforce members on security policies.',
...
CTA Exam Strategy: Administrative safeguards organize people and processes; physical safeguards protect spaces and devices; technical safeguards control systems and data.',
	...
	array(
		...
		'option_a'       => 'Security practices are optional when a client signs a telehealth waiver.',
		'option_b'       => 'Only large group practices must comply with security requirements.',
		'option_c'       => 'Using a popular video platform satisfies the rule without further analysis.',
...
CTA Exam Strategy: A waiver, product label, or practice size does not replace the BBS telehealth standard.',
	...
	array(
		...
		'option_a'       => 'Shared access is acceptable if the password is changed once a year.',
		'option_b'       => 'The practice cannot reliably identify individual access or limit privileges, weakening accountability and least-privilege controls.',
		'option_c'       => 'The only concern is whether clients were told that staff use the system.',
...
CTA Exam Strategy: Shared credentials usually signal authentication, auditability, and least-privilege problems.',
	...
	array(
		...
		'option_a'       => 'The cloud provider is generally a business associate, and the practice must obtain an appropriate BAA while also evaluating the service’s security and terms.',
		'option_b'       => 'A BAA is unnecessary because the vendor states that employees do not read the records.',
		'option_c'       => 'A BAA guarantees that every configuration and workflow is HIPAA compliant.',
...
CTA Exam Strategy: “Stores PHI on behalf of the practice” is a strong business-associate clue.',
	...
	array(
		...
		'option_a'       => 'Assume no incident occurred because the device was encrypted.',
		'option_b'       => 'Notify every client immediately before confirming what information was on the laptop.',
		'option_c'       => 'Activate the incident-response plan, attempt containment, verify the encryption and information involved, preserve relevant evidence, and assess notification duties.',
...
CTA Exam Strategy: Encryption is important evidence, not permission to ignore a lost device.',
	...
	array(
		...
		'option_a'       => 'Wait to see whether the recipient opens the message.',
		'option_b'       => 'Delete the therapist’s sent copy so the disclosure is no longer documented.',
		'option_c'       => 'Send a second email containing more client details to explain the mistake.',
...
CTA Exam Strategy: Wrong-recipient questions favor containment and assessment, not waiting, concealment, or additional disclosure.',
	...
	array(
		...
		'option_a'       => 'Encryption is optional whenever it would cost money.',
		'option_b'       => 'The practice must assess whether encryption is reasonable and appropriate and implement it, or document a reasonable and appropriate alternative or why it is not reasonable and appropriate in the circumstances.',
		'option_c'       => 'Encryption is prohibited unless a client signs a special authorization.',
...
CTA Exam Strategy: On the exam, translate “addressable” as “evaluate, implement or use an equivalent, and document” - not “optional.”',
	...
	array(
		...
		'option_a'       => 'No further action is necessary because the backup software reports success.',
		'option_b'       => 'Delete older backups so only the newest copy remains.',
		'option_c'       => 'Test restoration, confirm that critical information can be recovered, protect the backup, and document the results and corrective action.',
...
CTA Exam Strategy: A backup is only useful when it can be restored.',
	...
	array(
		...
		'option_b'       => 'Ignore the notice because there is no confirmed breach.',
		'option_c'       => 'Immediately notify every client that their information was stolen.',
...
CTA Exam Strategy: Distinguish a vulnerability from a confirmed breach: correct the risk promptly without inventing facts.',
	...
	array(
		...
		'option_a'       => 'Whether the therapist intended to disclose the spreadsheet.',
		'option_b'       => 'Whether the practice has liability insurance.',
		'option_c'       => 'Whether the employee has previously received a positive performance review.',
...
CTA Exam Strategy: Memorize the four factors: information, recipient, acquisition/viewing, mitigation.',
	...
	array(
		...
		'option_a'       => 'The LMFT is correct because cash payment creates a complete exemption from technology security.',
		'option_b'       => 'The LMFT needs to follow only the platform vendor’s security policy.',
		'option_c'       => 'Regardless of the separate federal covered-entity analysis, 16 CCR section 1815.5(d)(3) requires BBS telehealth providers to comply with the identified California confidentiality requirements and HIPAA Security standards as part of the California telehealth standard.',
...
CTA Exam Strategy: This question separates federal HIPAA status from the independent California BBS telehealth requirement.',
	...
	array(
		...
		'option_a'       => 'Use it immediately because AI-generated notes reduce documentation time.',
		'option_b'       => 'Evaluate legal authority and recording requirements, vendor and business-associate status, data use and retention, security, client understanding, clinical appropriateness, accuracy, and human review before deciding whether and how to use it.',
		'option_c'       => 'Ask the vendor whether the product is popular with other therapists; popularity establishes compliance.',
...
CTA Exam Strategy: When a tool records, stores, analyzes, and trains on data, analyze every function rather than the product label.',
	...
	array(
		...
		'option_a'       => 'Activate the incident and contingency plans, isolate affected systems, preserve evidence, use safe continuity procedures, assess possible data acquisition, consult appropriate experts, and document decisions and notifications.',
		'option_b'       => 'Restore the backup immediately on the compromised network without investigating the attack.',
		'option_c'       => 'Pay the demand immediately because payment proves that no breach occurred.',
...
CTA Exam Strategy: Ransomware is an integrated CIA problem: contain, preserve, recover safely, and assess exfiltration.',
	...
	array(
		...
		'option_a'       => 'Notify every client and the BBS immediately, then determine what happened.',
		'option_b'       => 'Replace the laptops but leave the shared accounts, vendor, and backup practices unchanged.',
		'option_c'       => 'Wait for proof that records were stolen because preventive action could alarm clients.',
