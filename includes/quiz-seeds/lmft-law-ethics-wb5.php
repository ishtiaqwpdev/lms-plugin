...
return array(
	array(
		'question_text'  => 'A therapist is considering an intervention that may create short-term distress but could serve a reasonable treatment purpose if carefully monitored. Which statement BEST describes the ethical principle of nonmaleficence?',
		'option_a'       => 'Clinicians must guarantee that clients never experience distress',
		'option_b'       => 'Clinicians should avoid and reduce unnecessary or unjustified harm',
		'option_c'       => 'Clinicians must follow every client request to preserve autonomy',
	...
	array(
		...
		'option_a'       => 'Nonmaleficence is one universal California statute governing every therapist decision',
		'option_b'       => 'Nonmaleficence is purely aspirational and has no relationship to professional duties',
		'option_c'       => 'Any client discomfort automatically proves a violation of California law',
	...
	array(
		...
		'option_a'       => 'The distress is connected to a reasonable treatment purpose, monitored, and adjusted to the client’s readiness and response',
		'option_b'       => 'The therapist believes discomfort always proves that treatment is working',
		'option_c'       => 'The client signed a general consent form at intake',
	...
	array(
		...
		'option_a'       => 'Explaining the foreseeable limitations of an intervention',
		'option_b'       => 'Modifying treatment after the client’s condition changes',
		'option_c'       => 'Failing to reassess after repeated signs of deterioration',
	...
	array(
		...
		'option_b'       => 'Only after the client files a written complaint',
		'option_c'       => 'Only after the Board determines that misconduct occurred',
	...
	array(
		...
		'option_a'       => 'Continue unchanged until the full planned protocol is completed',
		'option_b'       => 'Terminate immediately because any worsening proves the intervention is harmful',
		'option_c'       => 'Reassess the client, treatment fit, benefit, and risk; consult as needed and modify the plan based on the findings',
	...
	array(
		...
		'option_a'       => 'Pressure the client until consent is obtained because likely benefit overrides refusal',
		'option_b'       => 'Clarify the client’s understanding and concerns, explain material risks and alternatives, respect the refusal, and consider other appropriate options',
		'option_c'       => 'End treatment immediately because refusal makes the client noncompliant',
	...
	array(
		...
		'option_a'       => 'Finish a complete diagnostic assessment before taking protective action',
		'option_b'       => 'Delay action until a consultant is available',
		'option_c'       => 'End the session to avoid increasing the client’s distress',
	...
	array(
		...
		'option_a'       => 'The relapse alone does not prove an ethical or legal violation; the clinician should review the decision process, response, and current needs',
		'option_b'       => 'Any adverse outcome establishes gross negligence',
		'option_c'       => 'The clinician has no further duty because the original plan was reasonable',
	...
	array(
		...
		'option_a'       => 'Continue at the same intensity because stopping always reinforces avoidance',
		'option_b'       => 'Conclude that all exposure treatment is unethical',
		'option_c'       => 'Reassess safety, readiness, consent, and clinical benefit; reduce intensity, pause, or modify the intervention as indicated',
	...
	array(
		...
		'option_a'       => 'Proceed because legal scope automatically establishes competence',
		'option_b'       => 'Do not provide the procedure without adequate preparation and support; seek qualified consultation or training and use an appropriate alternative, collaboration, or referral',
		'option_c'       => 'Proceed if the client signs a form accepting all risks',
	...
	array(
		...
		'option_a'       => 'Accept the agreement because the client said yes',
		'option_b'       => 'Tell the client that power differences are unavoidable and need no further discussion',
		'option_c'       => 'Document the client’s statement and make the change immediately',
	...
	array(
		...
		'option_a'       => 'The ethical principle broadly guides harm avoidance, while Business and Professions Code section 4982 identifies particular grounds such as intentional or reckless client harm, gross negligence, and incompetence',
		'option_b'       => 'Every failure to maximize benefit is automatically intentional harm under California law',
		'option_c'       => 'A clinician violates California law whenever a client reports feeling worse after a session',
	...
	array(
		...
		'option_a'       => 'Wait to see whether the client experiences actual harm',
		'option_b'       => 'Focus only on disciplining the registered AMFT before addressing the client',
		'option_c'       => 'Address the client’s immediate safety and continuity needs, involve the supervisor, and then evaluate, document, and correct the omissions',
	...
	array(
		...
		'option_a'       => 'Continue unchanged because employer instructions eliminate the clinician’s responsibility',
		'option_b'       => 'Take prompt steps to protect affected clients, document and communicate the risk through appropriate channels, seek workload or coverage changes, and escalate or consult if the risk persists',
		'option_c'       => 'Resign immediately without arranging continuity for current clients',
	...
	array(
		...
		'option_a'       => 'Delete the sent-message record so no one is alarmed',
		'option_b'       => 'Assume no harm occurred because the recipient promised deletion',
		'option_c'       => 'Immediately announce publicly that a reportable breach occurred',
	...
	array(
		...
		'option_b'       => 'Continue because supervisor approval and client agreement eliminate competence and harm concerns',
		'option_c'       => 'Terminate the client immediately because worsening proves the entire therapeutic relationship is harmful',
	...
	array(
		...
		'option_a'       => 'Guarantee successful treatment outcomes',
		'option_b'       => 'Eliminate every possibility of client distress',
		'option_c'       => 'Identify and reasonably reduce foreseeable risks to client welfare',
	...
	array(
		...
		'option_b'       => 'The intake assessment is legally invalid after the first session',
		'option_c'       => 'Every session requires a new comprehensive written assessment',
	...
	array(
		...
		'option_a'       => 'A clinician must obtain every possible fact before taking any action',
		'option_b'       => 'Assessment is needed only when the client requests it',
		'option_c'       => 'Assessment replaces professional judgment',
	...
	array(
		...
		'option_a'       => 'It guarantees that the client will agree with every recommendation',
		'option_b'       => 'It reduces material misunderstandings about roles, treatment, risks, policies, availability, and emergencies',
		'option_c'       => 'It allows the clinician to avoid checking the client’s understanding',
	...
	array(
		...
		'option_a'       => 'Its primary purpose is to make the clinician impossible to discipline',
		'option_b'       => 'It preserves material findings, reasoning, communication, plans, and follow-up needed for competent and continuous care',
		'option_c'       => 'It should omit uncertainty so the clinician appears decisive',
	...
	array(
		...
		'option_a'       => 'Ignore the events because each could have an innocent explanation',
		'option_b'       => 'Immediately terminate the registered AMFT’s registration',
		'option_c'       => 'Wait for actual client injury before intervening',
	...
	array(
		...
		'option_b'       => 'Continue unchanged because treatment choices belong only to the clinician',
		'option_c'       => 'Blame the client for failing to trust professional expertise',
	...
	array(
		...
		'option_a'       => 'Continue because frequent availability always demonstrates beneficence',
		'option_b'       => 'Block the client without discussion or continuity planning',
		'option_c'       => 'Assess the dependency and risk, clarify communication and emergency boundaries, repair expectations, consult as needed, and monitor the effect on treatment',
	...
	array(
		...
		'option_a'       => 'Wait for the client to explicitly request a suicide assessment',
		'option_b'       => 'Conduct a focused safety assessment and take protective action based on the level of risk found',
		'option_c'       => 'Avoid asking about suicide because the question could create risk',
	...
	array(
		...
		'option_a'       => 'Continue because general evidence overrides this client’s response',
		'option_b'       => 'Assume the client is not trying hard enough',
		'option_c'       => 'Terminate immediately without assessing alternatives or continuity',
	...
	array(
		...
		'option_a'       => 'Evaluate the advice, verify the controlling duty and relevant facts, seek additional qualified help if needed, and make and document the professional decision',
		'option_b'       => 'Follow the consultant automatically because consultation transfers responsibility',
		'option_c'       => 'Ignore all consultation whenever there is disagreement',
	...
	array(
		...
		'option_a'       => 'Delete the original entry without leaving any indication of the change',
		'option_b'       => 'Leave the error because changing any record is always prohibited',
		'option_c'       => 'Correct or amend the record transparently under applicable procedures, preserve the integrity of the history, and address any care affected by the error',
	...
	array(
		...
		'option_a'       => 'Defend the therapist’s memory and end the discussion',
		'option_b'       => 'Explore the client’s experience and understanding, clarify voluntariness and alternatives, assess any power or communication problem, and adjust and document the plan',
		'option_c'       => 'Terminate immediately because disagreement proves irreparable harm',
	...
	array(
		...
		'option_a'       => 'Wait until every fact is verified before responding',
		'option_b'       => 'Delete the message because it may be inaccurate',
		'option_c'       => 'Complete routine documentation before contacting the supervisor or addressing safety',
	...
	array(
		...
		'option_a'       => 'Address the client’s safety and voluntariness, stop or correct the clinician-centered pattern, obtain qualified consultation, repair or transition care as appropriate, and document and monitor the response',
		'option_b'       => 'Continue because generosity makes the arrangement harmless',
		'option_c'       => 'Ask the client to sign consent for the dual emotional role',
	...
	array(
		...
		'option_a'       => 'Wait because technology failures are solely the vendor’s responsibility',
		'option_b'       => 'Tell clients to monitor the clinic’s system themselves',
		'option_c'       => 'Use an immediate backup process, identify and contact affected clients, assess harm and risk, document and escalate the system problem, and verify that corrective measures work',
	...
	array(
		...
		'option_a'       => 'Continue the pattern because the client values availability and no emergency is present',
		'option_b'       => 'Promptly reassess safety and treatment effectiveness, involve the supervisor, clarify communication and emergency boundaries, address dependency and the missed follow-up, modify or coordinate care as needed, and document and monitor the plan',
		'option_c'       => 'Terminate immediately without discussion to restore boundaries',
	...
	array(
		...
		'option_a'       => 'It guarantees that treatment will improve every client',
		'option_b'       => 'It requires the clinician to agree with every client request',
		'option_c'       => 'It directs the clinician to take competent, reasonable action intended to promote client welfare',
	...
	array(
		...
		'option_a'       => 'Beneficence emphasizes promoting welfare; nonmaleficence emphasizes avoiding or reducing unnecessary harm',
		'option_b'       => 'Beneficence is legally enforceable in every case, while nonmaleficence is optional',
		'option_c'       => 'Beneficence concerns documentation, while nonmaleficence concerns billing',
	...
	array(
		...
		'option_a'       => 'The lack of improvement automatically proves misconduct',
		'option_b'       => 'Beneficence is irrelevant because the outcome was disappointing',
		'option_c'       => 'The therapist should alter the record to show improvement',
	...
	array(
		...
		'option_a'       => 'The clinician should make every decision because professional training always overrides preference',
		'option_b'       => 'The clinician should offer reasoned recommendations and support informed client participation among appropriate options',
		'option_c'       => 'The clinician should avoid making any professional recommendation',
	...
	array(
		...
		'option_a'       => 'Choose the most intensive intervention because more treatment always creates more benefit',
		'option_b'       => 'Consider potential benefit but disregard burden and risk',
		'option_c'       => 'Compare expected benefit, material risk, alternatives, client fit, feasibility, and how outcomes will be monitored',
	...
	array(
		...
		'option_a'       => 'Pressure the client until the preferred intervention is accepted',
		'option_b'       => 'Respect the informed choice, clarify the plan and monitoring, and revisit the decision if new clinical information develops',
		'option_c'       => 'Terminate immediately because disagreement undermines treatment',
	...
	array(
		...
		'option_a'       => 'Continue indefinitely because the intervention was reasonable at intake',
		'option_b'       => 'Blame the client for failing to benefit',
		'option_c'       => 'End services immediately without discussing alternatives or continuity',
	...
	array(
		...
		'option_a'       => 'Make a client-centered clinical assessment, disclose or manage the conflict as appropriate, and facilitate qualified evaluation or referral when indicated',
		'option_b'       => 'Withhold the option because the clinic’s incentive determines the client’s best interest',
		'option_c'       => 'Refer every clinic client automatically to avoid any appearance of conflict',
	...
	array(
		...
		'option_a'       => 'Provide it immediately because potential benefit overrides competence',
		'option_b'       => 'Hide the option so the client does not ask questions',
	...
	array(
		...
		'option_a'       => 'Any action that reduces distress immediately is beneficent',
		'option_b'       => 'Assess risk and dependency, clarify sustainable communication and emergency plans, support coping, and monitor long-term treatment impact',
		'option_c'       => 'Ignore the client’s distress and block all contact without discussion',
	...
	array(
		...
		'option_a'       => 'Ignore the barrier because access is never clinically relevant',
		'option_b'       => 'Guarantee transportation that the registered AMFT cannot control',
		'option_c'       => 'Disclose the client’s information broadly to community organizations without authorization or another lawful basis',
	...
	array(
		...
		'option_a'       => 'Require Option 1 because speed is the only measure of benefit',
		'option_b'       => 'Choose whichever option is easier for the LMFT to document',
		'option_c'       => 'Discuss the comparative benefits, burdens, uncertainty, and monitoring plan, and proceed with the accessible reasonable option if the informed client chooses it',
	...
	array(
		...
		'option_a'       => 'Close the case without assessment because policy eliminates professional responsibility',
		'option_b'       => 'Assess current need and risk, raise the client-specific concern through appropriate channels, explore authorized exceptions or alternatives, and protect continuity',
		'option_c'       => 'Promise unlimited treatment regardless of program authority or resources',
	...
	array(
		...
		'option_a'       => 'Arrange hospitalization solely because the most restrictive option must be most beneficial',
		'option_b'       => 'Dismiss the request without exploring the client’s fear',
		'option_c'       => 'Promise that outpatient care carries no risk',
	...
	array(
		...
		'option_a'       => 'Stop imposing the therapist’s value, reassess safety and goals, acknowledge the client’s autonomy, seek consultation regarding bias, and support a client-centered plan',
		'option_b'       => 'Continue because good intentions prove the recommendation is beneficial',
		'option_c'       => 'Tell the client disagreement demonstrates incapacity',
	...
	array(
		...
		'option_a'       => 'Continue unchanged because the original plan was once appropriate',
		'option_b'       => 'Terminate immediately and tell the client to locate care alone',
	...
	array(
		...
		'option_a'       => 'Guaranteeing a favorable outcome for every client',
		'option_b'       => 'Following personal preference whenever law is unclear',
		'option_c'       => 'Transferring all duties to a consultant',
	...
	array(
		...
		'option_a'       => 'Truthfully evaluating conduct and taking proportionate protective, corrective, and preventive action',
		'option_b'       => 'Accepting blame for every event in the workplace',
		'option_c'       => 'Concealing minor problems to preserve client confidence',
	...
	array(
		...
		'option_a'       => 'Protecting the therapist’s reputation',
		'option_b'       => 'Completing a full blame analysis',
		'option_c'       => 'Assessing and addressing current client risk or harm',
	...
	array(
		...
		'option_a'       => 'Backdating a late entry so the chart appears complete',
		'option_b'       => 'Using the approved correction process while preserving an accurate history and audit trail',
		'option_c'       => 'Deleting accurate material that may look unfavorable',
	...
	array(
		...
		'option_a'       => 'The consultant becomes responsible for every later outcome',
		'option_b'       => 'The clinician must follow any advice without evaluation',
		'option_c'       => 'Consultation eliminates the need to consider applicable law',
	...
	array(
		...
		'option_a'       => 'First determine which employee should be blamed',
		'option_b'       => 'Promptly assess the client’s current safety and take indicated protective action, then address documentation, consultation, and process correction',
		'option_c'       => 'Wait until the next appointment because the original session ended',
	...
	array(
		...
		'option_a'       => 'Insert it and change the system date to yesterday',
		'option_b'       => 'Delete the original note and replace it without explanation',
		'option_c'       => 'Leave the record inaccurate because any correction creates liability',
	...
	array(
		...
		'option_a'       => 'Clarify what the client understood, provide accurate information, assess decision impact, correct the process if needed, and document the material discussion',
		'option_b'       => 'Dismiss the concern because the policy was posted online',
		'option_c'       => 'Insist that confusion proves the client was not listening',
	...
	array(
		...
		'option_a'       => 'Continue withholding the information unless the client complains',
		'option_b'       => 'Ask a peer to keep the matter private',
		'option_c'       => 'Promptly provide the supervisor with complete material facts, assess current client needs, follow corrective guidance consistent with law, and document appropriately',
	...
	array(
		...
		'option_a'       => 'Ignore the error because claims are administrative',
		'option_b'       => 'Alter the clinical record to support the transmitted diagnosis',
		'option_c'       => 'Tell the client that the insurer caused the mistake without investigation',
	...
	array(
		...
		'option_a'       => 'Publicly accuse the colleague to warn everyone',
		...
		'option_c'       => 'Ignore the information because only clients may raise concerns',
	...
	array(
		...
		'option_a'       => 'Contain the failure, identify affected clients, assess current risk, restore communication or alternatives, preserve evidence, notify through required channels, correct the system, and verify the fix',
		'option_b'       => 'Wait for clients to resend messages',
		'option_c'       => 'Delete the failed-message logs to reduce exposure',
	...
	array(
		...
		'option_a'       => 'Say nothing because disclosure could damage trust',
		'option_b'       => 'Immediately provide every internal detail to relieve the clinician’s guilt',
		'option_c'       => 'Clarify impact and controlling duties, obtain timely qualified consultation, correct the problem, and communicate material client-centered information through an authorized approach',
	...
	array(
		...
		'option_a'       => 'Comply because an employer assumes all responsibility',
		'option_b'       => 'Delete the entire chart',
		'option_c'       => 'Follow the instruction but keep a private truthful copy at home',
	...
	array(
		...
		'option_a'       => 'Contain access if possible, preserve evidence, determine the information and recipients involved, assess risk under applicable law and policy, consult appropriate privacy resources, and notify when required',
		'option_b'       => 'Assume no breach occurred because opening is unconfirmed',
		'option_c'       => 'Notify every client and agency before identifying whose information was involved',
	...
	array(
		...
		'option_a'       => 'Choose the easier opinion because consultation eliminates responsibility',
		'option_b'       => 'Verify the controlling authority and facts, consider each consultant’s expertise and reasoning, obtain additional qualified guidance if needed, and make a documented professional decision',
		'option_c'       => 'Average the two opinions',
	...
	array(
		...
		'option_a'       => 'Correct the note first and wait until the next supervision meeting',
		'option_b'       => 'Call the client, but leave the record and supervisor uninformed',
		'option_c'       => 'Promptly assess and protect the client, inform the supervisor with complete facts, preserve and correct the record transparently, determine required communication or reporting, document the response, and repair the workflow',
	...
	array(
		...
		'option_a'       => 'A structured process integrating facts, governing standards, clinical knowledge, client circumstances, risks, and alternatives',
		'option_b'       => 'The therapist’s first instinct',
		'option_c'       => 'Whatever practice is most common at the workplace',
	...
	array(
		...
		'option_a'       => 'Balance the duty against administrative convenience',
		'option_b'       => 'Ask whether colleagues usually follow it',
		'option_c'       => 'Identify and comply with the controlling requirements while using judgment within any discretion they leave',
	...
	array(
		...
		'option_a'       => 'The client reported missing three appointments',
		'option_b'       => 'The record shows the consent form was signed yesterday',
		'option_c'       => 'The supervisor stated that no consultation occurred',
	...
	array(
		...
		'option_a'       => 'Always delay until every fact is known',
		'option_b'       => 'Gather enough relevant information for the risk and timing, while taking necessary protective action when delay would increase harm',
		'option_c'       => 'Treat every uncertainty as an emergency',
	...
	array(
		...
		'option_a'       => 'It provides additional information that the clinician must evaluate using independent professional judgment',
		'option_b'       => 'It transfers responsibility to the consultant',
		'option_c'       => 'It automatically proves the final decision is lawful',
	...
	array(
		...
		'option_a'       => 'Document dishonesty as fact',
		'option_b'       => 'Terminate immediately',
	...
	array(
		...
		'option_a'       => 'Override the client because professional training always controls',
		'option_b'       => 'Discuss comparative benefits, risks, and monitoring, then respect the informed reasonable choice',
		'option_c'       => 'Provide no recommendation at all',
	...
	array(
		...
		'option_a'       => 'Follow the policy because employment replaces professional responsibility',
		'option_b'       => 'Ignore it secretly and create an undocumented workflow',
		'option_c'       => 'Resign immediately without addressing continuity',
	...
	array(
		...
		'option_b'       => 'A legal requirement to terminate immediately',
		'option_c'       => 'Proof that the client lacks capacity',
	...
	array(
		...
		'option_a'       => 'The most restrictive option to reduce therapist anxiety',
		'option_b'       => 'Whichever requires less documentation',
		'option_c'       => 'The less intrusive option that adequately meets the legal and clinical need',
	...
	array(
		...
		'option_a'       => 'Make the decision because the client requested it',
		'option_b'       => 'Help the client clarify values, goals, options, and consequences while avoiding unnecessary substitution of therapist judgment',
		'option_c'       => 'Refuse to discuss the issue',
	...
	array(
		...
		'option_a'       => 'Handled appropriately',
		'option_b'       => 'Every private thought and fear the clinician experienced',
		'option_c'       => 'Documentation only if the outcome is unfavorable',
	...
	array(
		...
		'option_a'       => 'Promptly assess available facts and take proportionate lawful protective action while continuing to clarify information',
		'option_b'       => 'Wait for complete certainty',
		'option_c'       => 'Dismiss the report because it is incomplete',
	...
	array(
		...
		'option_a'       => 'Follow the advice because consultation transfers responsibility',
		'option_b'       => 'Reject it solely because the clinician’s first view must be correct',
		'option_c'       => 'Take no action until the consultant accepts liability',
	...
	array(
		...
		'option_a'       => 'The outcome alone proves misconduct',
		'option_b'       => 'Evaluate the original reasoning using information reasonably available at the time, then respond appropriately to the new outcome',
		'option_c'       => 'A bad outcome means no decision should have been made',
	...
	array(
		...
		'option_a'       => 'Override the client immediately',
		'option_b'       => 'Follow the preference without assessing risk',
		'option_c'       => 'Clarify facts and authority, assess seriousness, discuss options and consequences with the client, consult as needed, and use the least intrusive effective response',
	...
	array(
		...
		'option_a'       => 'Address urgent safety, clarify facts, identify governing standards, examine bias, include the client, consult appropriately, compare proportionate options, act, document, and reevaluate',
		'option_b'       => 'Follow the initial emotional reaction',
		'option_c'       => 'Follow agency preference without independent review',
