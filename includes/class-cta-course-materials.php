...
class CTA_Course_Materials {
	...
	private static function find_course_for_bundle( array $bundle ) {
		...
		if ( '' !== $code && 'CTA-CE-002' === $code && class_exists( 'CTA_Telehealth_Exam_Sync' ) && method_exists( 'CTA_Telehealth_Exam_Sync', 'find_course' ) ) {
			$course = CTA_Telehealth_Exam_Sync::find_course();
			if ( $course ) {
				return $course;
			}
		}
