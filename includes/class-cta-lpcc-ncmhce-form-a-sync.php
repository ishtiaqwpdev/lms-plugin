<?php
/**
 * LPCC NCMHCE Form A v2.0 live assessment sync (post-cutover).
 *
 * Rebuilds the active form_a quiz from the v2.0 learner seed after legacy forms
 * are archived. Preserves fixed 143-item order (no shuffling).
 *
 * @package CTA_LMS
 */
...
class CTA_Lpcc_Ncmhce_Form_A_Sync {

	const SEED_OPTION   = 'cta_lpcc_ncmhce_form_a_v2_live_1_0_265';
	const QUIZ_TYPE     = 'form_a';
	const FORM_TITLE    = 'Form A — 143-Question Comprehensive Simulation (Candidate Exam)';
